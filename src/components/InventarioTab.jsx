            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
              <div className="relative flex-1 sm:w-64">
                <input
                  ...
                  className="w-full pl-8 pr-4 py-2 bg-gray-50 border border-gray-250 rounded-xl text-xs font-semibold focus:bg-white focus:border-blush-palmLeaf outline-none transition-all"
                />
